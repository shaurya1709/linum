function load() {
document.getElementById('loaddiv').style.animation = 'fade 0.5s'
setTimeout(() => { document.getElementById('loaddiv').remove() }, 500)
...
var inits = {	
  ...
  branding: false,	
  font_formats:
   'Abril Fatface=Abril Fatface, Emoji; Alegreya=Alegreya, Emoji; Alegreya SC=Alegreya SC, Emoji; Amatic SC=Amatic SC, Emoji; Andada Pro=Andada Pro, Emoji; Archivo=Archivo, Emoji; Arvo=Arvo, Emoji; Asar=Asar, Emoji; Atiba=Atiba, Emoji, sans-serif; Atkinson Hyperlegible=Atkinson Hyperlegible, Emoji; B612=B612; Baloo 2=Baloo 2, Baloo Bhai 2, Baloo Bhaina 2, Baloo Chettan 2, Baloo Da 2, Baloo Paaji 2, Baloo Tamma 2, Baloo Tammudu 2, Baloo Thambi 2, Emoji, sans-serif; BioRhyme=BioRhyme, Emoji; Cardo=Cardo, Emoji; Carnevalee Freakshow=Carnevalee Freakshow, Emoji; Cairo=Cairo, Emoji; Cobaissi=Cobaissi, Emoji; Comfortaa=Comfortaa, Emoji; Cormorant=Cormorant, Emoji; Concert One=Concert One, Emoji; Crimson Text=Crimson Text, Emoji; DM Mono=DM Mono, Emoji; DM Sans=DM Sans, Emoji; DM Serif Display=DM Serif Display, Emoji; DM Serif Text=DM Serif Text, Emoji; Epilogue=Epilogue, Emoji; Fjalla One=Fjalla One, Emoji; Frank Ruhl Libre=Frank Ruhl Libre, Emoji; Georama=Georama, Emoji; Hahmlet=Hahmlet, Emoji; Heebo=Heebo, Emoji; Higher=HigherFont, Emoji; Hind Siliguri=Hind Siliguri, Emoji; IBM Plex Sans=IBM Plex Sans, Emoji; IBM Plex Serif=IBM Plex Serif, Emoji; IBM Plex Mono=IBM Plex Mono, Emoji; Inconsolata=Inconsolata, Emoji; Inter=Inter, Emoji; Josefin Slab=Josefin Slab, Emoji; Karla=Karla, Emoji; Kompakt=Kompakt, Emoji; Kumbh Sans=Kumbh Sans, Emoji; Lato=Lato, Emoji; Less Sans=Less Sans, Emoji; Lexend=Lexend, Emoji; Libre Franklin=Libre Franklin, Emoji; Lobster=Lobster, Emoji; Lora=Lora, Emoji; Merriweather=Merriweather, Emoji; Metropolis=Metropolis, Emoji; Monsterrat=Montserrat, Emoji; Muli=Muli, Emoji; Mulish=Mulish, Emoji; Neucha=Neucha, Emoji; Noto Sans=Noto Sans, Emoji; Nunito=Nunito, Emoji; Nunito Sans=Nunito Sans, Emoji; Old Standard TT=Old Standard TT, Emoji; Open Sans=Open Sans, Emoji; Oswald=Oswald, Emoji; Pacifico=Pacifico, Emoji; Patrick Hand=Patrick Hand, Emoji; Permanent Marker=Permanent Marker, Emoji; Playfair Display=Playfair Display, Emoji; Poppins=Poppins, Emoji; PT Serif=PT Serif, Emoji; Qahiri=Qahiri, Emoji; Quicksand=Quicksand, Emoji; Rakkas=Rakkas, Emoji; Raleway=Raleway, Emoji; Recursive=Recursive, Emoji; Red Hat=RedHat, Emoji; Red Hat Display=RedHatDisplay, Emoji; Red Hat Mono=RedHatMono, Emoji; Roboto=Roboto, Emoji; Roboto Condensed=Roboto Condensed, Emoji; Roboto Mono=Roboto Mono, Emoji; Roboto Slab=Roboto Slab, Emoji; Rhodium Libre=Rhodium Libre, Emoji; Rubik=Rubik, Emoji; Sans Serif=sans-serif; Source Code Pro=Source Code Pro, Emoji; Source Sans Pro=Source Sans Pro, Emoji; Space Grotesk=Space Grotesk, Emoji; Space Mono=Space Mono, Emoji; Spectral=Spectral, Emoji; Staatliches=Staatliches, Emoji; Style Script=Style Script, Emoji; Titillium Web=Titillium Web, Emoji; Ubuntu=Ubuntu, Emoji; Ubuntu Condensed=Ubuntu Condensed, Emoji; Ubuntu Mono=Ubuntu Mono, Emoji; Varela=Varela, Emoji; Verdana=verdana,geneva, Emoji; Vibur=Vibur, Emoji; Vollkorn=Vollkorn, Emoji; Wanderlust=Wanderlust, Emoji; Linum Round=LinumSans, Emoji; Work Sans=Work Sans, Emoji; Yomogi=Yomogi, Emoji; Zen Loop=Zen Loop, Emoji; CSS Debug=serif;',	
  width: '100vw',
  height: '100vh',	
  mobile: {
	  toolbar:
    ...
    items: [ // A list of panel components
      {
        ...
        html: '<iframe width="1206" height="678" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
      }
    ]
  },
